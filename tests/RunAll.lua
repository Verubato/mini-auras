...
local testFiles = {
    ...
    "tests/Modules/TestPortraitEllesmereMask.lua",
    ...
    "tests/Modules/TestCrowdControlDisplay.lua",
    ...
    "tests/Modules/TestImportantAurasNumbers.lua",
    ...
    "tests/Config/TestCrowdControlPanel.lua",
