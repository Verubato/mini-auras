...
-- duel start, and a unit leaving or re-entering the player's visible world. Subscribers react by
-- refreshing their module, and a module is entitled to re-seed its own baselines while doing so -
-- which is the hazard these cover.
