...
L:SetDefaultStrings({
	...
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Nudges the mark sideways from its corner. Positive is right, negative is left.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Nudges the mark up or down from its corner. Positive is up, negative is down.",
	...
	["Replace the group buffs"] = "Replace the group buffs",
	["Replace the group debuffs"] = "Replace the group debuffs",
	["Replace the target and focus auras"] = "Replace the target and focus auras",
	["Right"] = "Right",
	["Show the missing buff"] = "Show the missing buff",
	...
	["Which corner of the unit frame the mark sits in."] = "Which corner of the unit frame the mark sits in.",
