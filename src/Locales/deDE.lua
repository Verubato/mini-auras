...
L:RegisterLocale("deDE", {
	...
	["It works by showing any 'important' buff with a maximum duration of 4.1 seconds or less (precognition is a 4 second buff)."] = "Es zeigt jeden 'wichtigen' Stärkungseffekt mit einer maximalen Dauer von 4,1 Sekunden oder weniger (Vorahnung ist ein 4-Sekunden-Buff).",
	["So if a unit happens to have some other short important buff then that icon would also show, sorry."] = "Falls eine Einheit zufällig einen anderen kurzen wichtigen Buff hat, wird dieses Symbol leider ebenfalls angezeigt.",
	["Grow"] = "Wachsen",
	...
	["Colour by category"] = "Nach Kategorie färben",
