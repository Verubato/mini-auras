...
L:RegisterLocale("deDE", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "Zeichnet die Auren auf Blizzards eigene Gruppen-, Schlachtzugs-, Ziel- und Fokusrahmen, anstelle derer, die das Spiel dort anzeigt.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "Zeichnet die Auren auf diese Rahmen, statt sie Blizzard zu überlassen.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Zeichnet die Stärkungszauber auf die Gruppen- und Schlachtzugsrahmen und schaltet Blizzards eigene ab, solange dies aktiv ist.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Zeichnet die Schwächungszauber auf die Gruppen- und Schlachtzugsrahmen und schaltet Blizzards eigene ab, solange dies aktiv ist.",
	["Filtered"] = "Gefiltert",
	...
	["Max icons"] = "Max. Symbole",
	["Mine"] = "Eigene",
	["My buffs"] = "Eigene Stärkungszauber",
	["My debuffs"] = "Eigene Schwächungszauber",
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Verschiebt die Markierung seitlich aus ihrer Ecke. Positiv ist rechts, negativ ist links.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Verschiebt die Markierung nach oben oder unten aus ihrer Ecke. Positiv ist oben, negativ ist unten.",
	...
	["Only short buffs"] = "Nur kurze Stärkungszauber",
	...
	["Replace the group buffs"] = "Stärkungszauber der Gruppe ersetzen",
	["Replace the group debuffs"] = "Schwächungszauber der Gruppe ersetzen",
	["Replace the target and focus auras"] = "Auren von Ziel und Fokus ersetzen",
	["Right"] = "Rechts",
	["Show the missing buff"] = "Fehlenden Buff anzeigen",
	...
	["Type a spell id and press Enter. The spell's own id, not the name."] = "Gib eine Zauber-ID ein und drücke Enter. Die ID des Zaubers, nicht den Namen.",
	["Under 1min"] = "Unter 1 Min.",
	["Which corner of the unit frame the mark sits in."] = "In welcher Ecke des Einheitenrahmens die Markierung sitzt.",
