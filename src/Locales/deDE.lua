...
L:RegisterLocale("deDE", function() return {
	...
	["Replaces Blizzard's own auras on the party, raid, target, and focus frames."] = "Ersetzt Blizzards eigene Auren auf den Gruppen-, Schlachtzugs-, Ziel- und Fokusfenstern.",
	...
	["Replaces Blizzard's debuff row, in the bottom left corner of each party and raid frame. Encounter mechanics lead it."] = "Ersetzt Blizzards Schwächungszauber-Reihe, in der unteren linken Ecke jedes Gruppen- und Schlachtzugsfensters. Kampfmechaniken stehen vorn.",
} end)
