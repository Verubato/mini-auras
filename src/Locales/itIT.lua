...
L:RegisterLocale("itIT", function() return {
	...
	["Group icon"] = "Icona del gruppo",
	["Draw the group's own icon on every aura instead of each spell's artwork."] = "Mostra l'icona del gruppo su ogni aura al posto dell'immagine di ogni incantesimo.",
