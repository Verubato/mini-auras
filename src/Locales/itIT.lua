...
["Excludes yourself from being tracked."] = "Ti esclude dal monitoraggio.",
	...
	["Shows which group members can interrupt and who is on cooldown."] = "Mostra quali membri del gruppo possono interrompere e chi è in recupero.",
	["Sort by readiness"] = "Ordina per disponibilità",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "Mostra prima le interruzioni pronte, poi chi torna disponibile prima.",
	["Show icon"] = "Mostra icona",
	["Show the interrupt's spell icon next to each bar."] = "Mostra l'icona dell'incantesimo di interruzione accanto a ogni barra.",
	...
	["Show raid marker"] = "Mostra simbolo incursione",
	["Show the raid marker of the enemy whose cast was interrupted."] = "Mostra il simbolo del nemico il cui incantesimo è stato interrotto.",
	["Bar Texture"] = "Texture barra",
	["Hide when ready"] = "Nascondi se pronta",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "Nasconde ogni barra finché la sua interruzione è pronta, lasciando solo quelle in recupero.",
})
