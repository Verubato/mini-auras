...
L:RegisterLocale("itIT", function() return {
	...
	["Buffs"] = "Benefici",
	["Centre"] = "Centro",
	["Class Buff"] = "Beneficio di classe",
	["Debuffs"] = "Penalità",
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "Disegna le aure sui riquadri di gruppo, incursione, bersaglio e focus di Blizzard, al posto di quelle messe dal gioco.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "Disegna le aure su quei riquadri invece di lasciarle a Blizzard.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Disegna i benefici sui riquadri di gruppo e incursione e disattiva quelli di Blizzard finché è attivo.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Disegna le penalità sui riquadri di gruppo e incursione e disattiva quelle di Blizzard finché è attivo.",
	["Filtered"] = "Filtrato",
	...
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Sposta il segno di lato rispetto al suo angolo. Positivo è a destra, negativo a sinistra.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Sposta il segno in alto o in basso rispetto al suo angolo. Positivo è in alto, negativo in basso.",
	...
	["Only short buffs"] = "Solo benefici brevi",
	...
	["Replace the group buffs"] = "Sostituisci i benefici di gruppo",
	["Replace the group debuffs"] = "Sostituisci le penalità di gruppo",
	["Replace the target and focus auras"] = "Sostituisci le aure di bersaglio e focus",
	["Right"] = "Destra",
	["Show the missing buff"] = "Mostra il beneficio mancante",
	...
	["Type a spell id and press Enter. The spell's own id, not the name."] = "Scrivi un ID incantesimo e premi Invio. L'ID dell'incantesimo, non il nome.",
	["Under 1min"] = "Meno di 1 min",
	["Which corner of the unit frame the mark sits in."] = "In quale angolo del riquadro dell'unità si trova il segno.",
