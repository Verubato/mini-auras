...
L:RegisterLocale("ptBR", function() return {
	...
	["Change the colour of the icon's glow and border, or of a bar's fill."] = "Muda a cor do brilho e da borda do ícone, ou do preenchimento de uma barra.",
	["Enabled"] = "Ativado",
	...
	["Display"] = "Exibição",
	["Bars"] = "Barras",
	["Sound only auras don't have an appearance."] = "Auras somente som não têm aparência.",
	["Sound only auras don't have a position."] = "Auras somente som não têm posição.",
