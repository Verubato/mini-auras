...
L:RegisterLocale("ptBR", {
	["In Blizzard's 12.1 patch, addons can no longer read any aura information. The following features are no longer possible and have been removed:\n- Cooldown tracking (friendly and enemy).\n- The warning text when the healer is CC'd.\n- Text-to-speech announcements.\n- Class colours on alert icons.\n- Masque icon skinning.\n\nSome good news though, we can now filter by spell id so auras are now customisable."] = "Com o patch 12.1, os addons não podem mais ler informações de auras. Os seguintes recursos não são mais possíveis e foram removidos:\n- Rastreamento de tempos de recarga (aliados e inimigos).\n- O texto de aviso quando o curandeiro está controlado.\n- Anúncios por voz (TTS).\n- Cores de classe nos ícones de alerta.\n- Escolha do tipo de brilho (os ícones sempre usam o brilho integrado).\n- Skins Masque nos ícones.\n\nUma boa notícia: agora podemos filtrar por ID de magia, então as auras são personalizáveis.",
...
["Excludes yourself from being tracked."] = "Exclui você do rastreamento.",
	...
	["Shows which group members can interrupt and who is on cooldown."] = "Mostra quais membros do grupo podem interromper e quem está em recarga.",
	["Sort by readiness"] = "Ordenar por disponibilidade",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "Mostra primeiro as interrupções prontas e depois quem volta mais cedo.",
	["Show icon"] = "Mostrar ícone",
	["Show the interrupt's spell icon next to each bar."] = "Mostra o ícone da magia de interrupção ao lado de cada barra.",
	...
	["Only show the bars while you are in combat."] = "Só mostra as barras enquanto você está em combate.",
	["Show raid marker"] = "Mostrar marcador de raide",
	["Show the raid marker of the enemy whose cast was interrupted."] = "Mostra o marcador do inimigo cuja magia foi interrompida.",
	["Bar Texture"] = "Textura da barra",
	["Hide when ready"] = "Ocultar quando pronta",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "Oculta cada barra enquanto sua interrupção está pronta, deixando apenas as em recarga.",
})
