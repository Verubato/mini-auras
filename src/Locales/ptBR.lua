...
L:RegisterLocale("ptBR", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "Desenha as auras nos quadros de grupo, raide, alvo e foco da Blizzard, no lugar das que o jogo coloca lá.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "Desenha as auras nesses quadros em vez de deixá-las para a Blizzard.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Desenha os bônus nos quadros de grupo e raide e desliga os da Blizzard enquanto estiver ativo.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Desenha as penalidades nos quadros de grupo e raide e desliga as da Blizzard enquanto estiver ativo.",
	["Filtered"] = "Filtrado",
	...
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Desloca a marca para os lados a partir do canto. Positivo é à direita, negativo à esquerda.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Desloca a marca para cima ou para baixo a partir do canto. Positivo é para cima, negativo para baixo.",
	...
	["Only short buffs"] = "Apenas bônus curtos",
	...
	["Replace the group buffs"] = "Substituir os bônus do grupo",
	["Replace the group debuffs"] = "Substituir as penalidades do grupo",
	["Replace the target and focus auras"] = "Substituir as auras de alvo e foco",
	["Right"] = "Direita",
	["Show the missing buff"] = "Mostrar o bônus que falta",
	...
	["Type a spell id and press Enter. The spell's own id, not the name."] = "Digite um ID de magia e pressione Enter. O ID da magia, não o nome.",
	["Under 1min"] = "Menos de 1 min",
	["Which corner of the unit frame the mark sits in."] = "Em qual canto do quadro da unidade a marca fica.",
