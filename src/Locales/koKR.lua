...
L:RegisterLocale("koKR", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "게임이 표시하는 것 대신, 블리자드의 파티, 공격대, 대상, 주시 대상 프레임에 직접 오라를 표시합니다.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "해당 프레임의 오라를 블리자드에 맡기지 않고 직접 표시합니다.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "파티 및 공격대 프레임에 버프를 표시하고, 켜져 있는 동안 블리자드의 버프는 끕니다.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "파티 및 공격대 프레임에 디버프를 표시하고, 켜져 있는 동안 블리자드의 디버프는 끕니다.",
	["Filtered"] = "필터 적용",
	["Glow colour"] = "발광 색상",
	...
	["My buffs"] = "내 버프",
	["My debuffs"] = "내 디버프",
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "표식을 모서리에서 좌우로 옮깁니다. 양수는 오른쪽, 음수는 왼쪽입니다.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "표식을 모서리에서 위아래로 옮깁니다. 양수는 위, 음수는 아래입니다.",
	...
	["Replace the group buffs"] = "파티 및 공격대 버프 대체",
	["Replace the group debuffs"] = "파티 및 공격대 디버프 대체",
	["Replace the target and focus auras"] = "대상 및 주시 대상 오라 대체",
	["Right"] = "오른쪽",
	["Show the missing buff"] = "빠진 버프 표시",
	...
	["Top right"] = "오른쪽 위",
	["Tracked buffs"] = "추적 버프",
	["Type a spell id and press Enter. The spell's own id, not the name."] = "주문 ID를 입력하고 Enter를 누르세요. 이름이 아니라 주문 자체의 ID입니다.",
	["Under 1min"] = "1분 미만",
	["Which corner of the unit frame the mark sits in."] = "표식이 놓일 유닛 프레임의 모서리입니다.",
