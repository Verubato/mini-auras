...
L:RegisterLocale("koKR", {
	...
	["It works by showing any 'important' buff with a maximum duration of 4.1 seconds or less (precognition is a 4 second buff)."] = "최대 지속시간이 4.1초 이하인 '중요' 버프를 표시하는 방식으로 작동합니다(예지는 4초 버프입니다).",
	["So if a unit happens to have some other short important buff then that icon would also show, sorry."] = "따라서 대상에게 다른 짧은 중요 버프가 있으면 해당 아이콘도 표시됩니다. 양해 바랍니다.",
	["Grow"] = "성장",
	["Icon Padding"] = "아이콘 여백",
	["Icon Size"] = "아이콘 크기",
	["Icon Size (%)"] = "아이콘 크기 (%)",
