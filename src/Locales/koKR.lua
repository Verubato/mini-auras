...
["Excludes yourself from being tracked."] = "자신을 추적에서 제외합니다.",
	...
	["Shows which group members can interrupt and who is on cooldown."] = "누가 차단할 수 있고 누가 재사용 대기 중인지 보여줍니다.",
	["Sort by readiness"] = "준비 순으로 정렬",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "준비된 차단을 먼저, 그다음 가장 빨리 돌아오는 순으로 표시합니다.",
	["Show icon"] = "아이콘 표시",
	["Show the interrupt's spell icon next to each bar."] = "각 막대 옆에 차단 주문 아이콘을 표시합니다.",
	["Bar Width"] = "막대 너비",
	["Bar Height"] = "막대 높이",
	["Bar Padding"] = "막대 간격",
	["Max Bars"] = "최대 막대 수",
	...
	["Show raid marker"] = "공격대 표식 표시",
	["Show the raid marker of the enemy whose cast was interrupted."] = "주문이 차단된 적의 표식을 표시합니다.",
	["Bar Texture"] = "막대 텍스처",
	["Hide when ready"] = "준비되면 숨기기",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "차단이 준비된 막대를 숨기고 재사용 대기 중인 것만 남깁니다.",
})
