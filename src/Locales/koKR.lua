...
L:RegisterLocale("koKR", {
	...
	["Change the colour of the icon's glow and border, or of a bar's fill."] = "아이콘의 발광과 테두리, 또는 바 채움의 색상을 변경합니다.",
	["Enabled"] = "활성화",
	...
	["Display"] = "표시 방식",
	["Bars"] = "바",
	["Sound only auras don't have an appearance."] = "소리만 사용하는 오라는 외형이 없습니다.",
	["Sound only auras don't have a position."] = "소리만 사용하는 오라는 위치가 없습니다.",
	["Sound only"] = "소리만",
	["Layout"] = "배치",
	["Spell name"] = "주문 이름",
