...
L:RegisterLocale("frFR", function() return {
	...
	["Buffs"] = "Améliorations",
	["Centre"] = "Centre",
	["Class Buff"] = "Amélioration de classe",
	["Debuffs"] = "Affaiblissements",
	["Debuffs take the first row and buffs the second, with the buffs moving up when the target has no debuffs."] = "Les affaiblissements occupent la première rangée et les améliorations la seconde. Les améliorations remontent quand la cible n'a aucun affaiblissement.",
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "Affiche les auras sur les cadres de groupe, de raid, de cible et de focalisation de Blizzard, à la place de celles que le jeu y met.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "Affiche les auras sur ces cadres au lieu de les laisser à Blizzard.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Affiche les améliorations sur les cadres de groupe et de raid, et désactive celles de Blizzard tant que l'option est active.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Affiche les affaiblissements sur les cadres de groupe et de raid, et désactive ceux de Blizzard tant que l'option est active.",
	["Filtered"] = "Filtré",
	...
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Décale la marque latéralement depuis son coin. Positif vers la droite, négatif vers la gauche.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Décale la marque vers le haut ou vers le bas depuis son coin. Positif vers le haut, négatif vers le bas.",
	...
	["Only short buffs"] = "Améliorations courtes uniquement",
	...
	["Replace the group buffs"] = "Remplacer les améliorations de groupe",
	["Replace the group debuffs"] = "Remplacer les affaiblissements de groupe",
	["Replace the target and focus auras"] = "Remplacer les auras de cible et de focalisation",
	["Right"] = "Droite",
	["Show the missing buff"] = "Afficher l'amélioration manquante",
	...
	["Type a spell id and press Enter. The spell's own id, not the name."] = "Saisissez un ID de sort et appuyez sur Entrée. L'ID du sort, pas son nom.",
	["Under 1min"] = "Moins d'1 min",
	["Which corner of the unit frame the mark sits in."] = "Le coin du cadre d'unité où se place la marque.",
