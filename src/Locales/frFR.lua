...
L:RegisterLocale("frFR", {
	...
	["Shows which group members can interrupt and who is on cooldown."] = "Montre quels membres du groupe peuvent interrompre et qui est en recharge.",
	["Sort by readiness"] = "Trier par disponibilité",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "Affiche d'abord les interruptions prêtes, puis celles qui reviennent le plus tôt.",
	["Show icon"] = "Afficher l'icône",
	["Show the interrupt's spell icon next to each bar."] = "Affiche l'icône du sort d'interruption à côté de chaque barre.",
	...
	["Show raid marker"] = "Afficher le symbole de raid",
	["Show the raid marker of the enemy whose cast was interrupted."] = "Affiche le symbole de l'ennemi dont le sort a été interrompu.",
	["Bar Texture"] = "Texture de barre",
	["Hide when ready"] = "Masquer si prêt",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "Masque chaque barre tant que son interruption est prête, ne laissant que celles en recharge.",
})
