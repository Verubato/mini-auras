...
L:RegisterLocale("frFR", {
	...
	["Change the colour of the icon's glow and border, or of a bar's fill."] = "Change la couleur de la lueur et de la bordure de l'icône, ou du remplissage d'une barre.",
	["Enabled"] = "Activé",
	...
	["Display"] = "Affichage",
	["Bars"] = "Barres",
	["Sound only auras don't have an appearance."] = "Les auras son uniquement n'ont aucune apparence.",
	["Sound only auras don't have a position."] = "Les auras son uniquement n'ont pas de position.",
