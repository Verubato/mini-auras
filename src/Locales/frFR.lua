...
L:RegisterLocale("frFR", function() return {
	...
	["Replaces Blizzard's own auras on the party, raid, target, and focus frames."] = "Remplace les auras de Blizzard sur les cadres de groupe, de raid, de cible et de focalisation.",
	...
	["Replaces Blizzard's debuff row, in the bottom left corner of each party and raid frame. Encounter mechanics lead it."] = "Remplace la rangée d'affaiblissements de Blizzard, dans le coin inférieur gauche de chaque cadre de groupe et de raid. Les mécaniques de rencontre passent en premier.",
} end)
