...
L:RegisterLocale("esES", function() return {
	...
	["Change the colour of the icon's glow and border, or of a bar's fill."] = "Cambia el color del brillo y el borde del icono, o del relleno de una barra.",
	["Enabled"] = "Habilitado",
	...
	["Bars"] = "Barras",
	["Sound only auras don't have an appearance."] = "Las auras de solo sonido no tienen apariencia.",
	["Sound only auras don't have a position."] = "Las auras de solo sonido no tienen posición.",
	...
	["Sound only auras have no such limit: they can play a sound for either aura type on any unit."] = "Las auras de solo sonido no tienen ese límite: pueden reproducir un sonido para ambos tipos de aura en cualquier unidad.",
