...
["Excludes yourself from being tracked."] = "將自己排除在追蹤之外。",
	...
	["Shows which group members can interrupt and who is on cooldown."] = "顯示隊伍中誰能打斷、誰在冷卻。",
	["Sort by readiness"] = "依就緒排序",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "先顯示已就緒的打斷，再依最快恢復的順序排列。",
	["Show icon"] = "顯示圖示",
	["Show the interrupt's spell icon next to each bar."] = "在每個狀態條旁顯示打斷法術的圖示。",
	["Bar Width"] = "狀態條寬度",
	["Bar Height"] = "狀態條高度",
	["Bar Padding"] = "狀態條間距",
	["Max Bars"] = "最大狀態條數",
	...
	["Show raid marker"] = "顯示團隊標記",
	["Show the raid marker of the enemy whose cast was interrupted."] = "顯示被打斷施法的敵人身上的團隊標記。",
	["Bar Texture"] = "狀態條材質",
	["Hide when ready"] = "就緒時隱藏",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "當某人的打斷已就緒時隱藏其狀態條，只留下冷卻中的。",
})
