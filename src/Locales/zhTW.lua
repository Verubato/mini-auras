...
L:RegisterLocale("zhTW", {
	...
	["It works by showing any 'important' buff with a maximum duration of 4.1 seconds or less (precognition is a 4 second buff)."] = "它透過顯示任何最大持續時間不超過4.1秒的'重要'增益來運作（預知是4秒增益）。",
	["So if a unit happens to have some other short important buff then that icon would also show, sorry."] = "因此，如果單位碰巧有其他短時間的重要增益，該圖示也會顯示，抱歉。",
	["Grow"] = "增長",
	["Icon Padding"] = "圖示間距",
	["Icon Size"] = "圖示大小",
	["Icon Size (%)"] = "圖示大小 (%)",
