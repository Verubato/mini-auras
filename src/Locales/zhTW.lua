...
L:RegisterLocale("zhTW", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "在暴雪自帶的隊伍、團隊、目標和專注目標框架上繪製光環，取代遊戲原本放在那裡的內容。",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "在這些框架上繪製光環，而不是交給暴雪處理。",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "在隊伍和團隊框架上繪製增益，並在啟用期間關閉暴雪自帶的增益。",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "在隊伍和團隊框架上繪製減益，並在啟用期間關閉暴雪自帶的減益。",
	["Filtered"] = "已篩選",
	["Glow colour"] = "發光顏色",
	...
	["My buffs"] = "我的增益",
	["My debuffs"] = "我的減益",
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "讓標記從所在角落左右偏移。正數向右，負數向左。",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "讓標記從所在角落上下偏移。正數向上，負數向下。",
	...
	["Refresh window"] = "刷新視窗",
	["Replace the group buffs"] = "取代隊伍增益",
	["Replace the group debuffs"] = "取代隊伍減益",
	["Replace the target and focus auras"] = "取代目標和專注目標光環",
	["Right"] = "右側",
	["Show the missing buff"] = "顯示缺少的增益",
	...
	["Top right"] = "右上",
	["Tracked buffs"] = "追蹤的增益",
	["Type a spell id and press Enter. The spell's own id, not the name."] = "輸入法術 ID 後按 Enter。填法術本身的 ID，不是名稱。",
	["Under 1min"] = "1 分鐘以內",
	["Which corner of the unit frame the mark sits in."] = "標記位於單位框架的哪個角落。",
