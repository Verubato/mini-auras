...
L:RegisterLocale("ruRU", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "Рисует эффекты на собственных рамках группы, рейда, цели и фокуса Blizzard вместо тех, что ставит игра.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "Рисует эффекты на этих рамках, вместо того чтобы оставлять их Blizzard.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Рисует усиления на рамках группы и рейда и отключает встроенные, пока включено.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Рисует ослабления на рамках группы и рейда и отключает встроенные, пока включено.",
	["Filtered"] = "С фильтром",
	...
	["My debuffs"] = "Мои ослабления",
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Сдвигает отметку вбок от её угла. Положительное значение вправо, отрицательное влево.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Сдвигает отметку вверх или вниз от её угла. Положительное значение вверх, отрицательное вниз.",
	...
	["Only short buffs"] = "Только короткие усиления",
	...
	["Replace the group buffs"] = "Заменять усиления группы",
	["Replace the group debuffs"] = "Заменять ослабления группы",
	["Replace the target and focus auras"] = "Заменять эффекты цели и фокуса",
	["Right"] = "Справа",
	["Show the missing buff"] = "Показывать недостающее усиление",
	...
	["Type a spell id and press Enter. The spell's own id, not the name."] = "Введите ID заклинания и нажмите Enter. Именно ID заклинания, а не название.",
	["Under 1min"] = "Меньше 1 мин",
	["Which corner of the unit frame the mark sits in."] = "В каком углу рамки юнита стоит отметка.",
