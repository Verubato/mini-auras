...
L:RegisterLocale("esMX", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "Dibuja las auras en los marcos de grupo, banda, objetivo y foco de Blizzard, en lugar de las que pone el juego.",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "Dibuja las auras en esos marcos en vez de dejárselas a Blizzard.",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Dibuja los beneficios en los marcos de grupo y banda, y desactiva los de Blizzard mientras está activo.",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "Dibuja los perjuicios en los marcos de grupo y banda, y desactiva los de Blizzard mientras está activo.",
	["Filtered"] = "Filtrado",
	...
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "Desplaza la marca en horizontal desde su esquina. Positivo es a la derecha, negativo a la izquierda.",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "Desplaza la marca arriba o abajo desde su esquina. Positivo es arriba, negativo es abajo.",
	...
	["Only short buffs"] = "Solo beneficios cortos",
	...
	["Replace the group buffs"] = "Reemplazar los beneficios de grupo",
	["Replace the group debuffs"] = "Reemplazar los perjuicios de grupo",
	["Replace the target and focus auras"] = "Reemplazar las auras de objetivo y foco",
	["Right"] = "Derecha",
	["Show the missing buff"] = "Mostrar el beneficio que falta",
	...
	["Type a spell id and press Enter. The spell's own id, not the name."] = "Escribe una ID de hechizo y presiona Enter. La ID del hechizo, no el nombre.",
	["Under 1min"] = "Menos de 1 min",
	["Which corner of the unit frame the mark sits in."] = "En qué esquina del marco de unidad se coloca la marca.",
