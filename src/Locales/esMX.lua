...
["Excludes yourself from being tracked."] = "Te excluye del seguimiento.",
	...
	["Shows which group members can interrupt and who is on cooldown."] = "Muestra qué miembros del grupo pueden interrumpir y quién está en reutilización.",
	["Sort by readiness"] = "Ordenar por disponibilidad",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "Muestra primero las interrupciones listas y después quien vuelve antes.",
	["Show icon"] = "Mostrar icono",
	["Show the interrupt's spell icon next to each bar."] = "Muestra el icono del hechizo de interrupción junto a cada barra.",
	...
	["Only show the bars while you are in combat."] = "Solo muestra las barras mientras estás en combate.",
	["Show raid marker"] = "Mostrar marca de banda",
	["Show the raid marker of the enemy whose cast was interrupted."] = "Muestra la marca del enemigo cuyo hechizo fue interrumpido.",
	["Bar Texture"] = "Textura de barra",
	["Hide when ready"] = "Ocultar si está lista",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "Oculta cada barra mientras su interrupción está lista, dejando solo las que están en reutilización.",
})
