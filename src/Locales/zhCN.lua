...
L:RegisterLocale("zhCN", function() return {
	...
	["Change the colour of the icon's glow and border, or of a bar's fill."] = "更改图标发光和边框的颜色，或条形填充的颜色。",
	["Enabled"] = "已启用",
	...
	["Display"] = "显示方式",
	["Bars"] = "条形",
	["Sound only auras don't have an appearance."] = "仅声音的光环没有外观设置。",
	["Sound only auras don't have a position."] = "仅声音的光环没有位置设置。",
	["Sound only"] = "仅声音",
	["Layout"] = "布局",
	["Spell name"] = "法术名称",
	...
	["Sound only auras have no such limit: they can play a sound for either aura type on any unit."] = "仅声音光环没有此限制：它们可以为任意单位上的两种光环类型播放声音。",
