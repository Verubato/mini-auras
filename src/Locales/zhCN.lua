...
L:RegisterLocale("zhCN", {
	...
	["Colour Countdown By Time"] = "按剩余时间为倒计时着色",
	["Colours the countdown timer text by the time remaining, from white through gold and orange to red as it runs out."] = "根据剩余时间为倒计时文字着色，从白色经金色、橙色渐变为红色。",
	["Icons"] = "图标",
	["Behaviour"] = "行为",
	["Glow Type"] = "发光类型",
