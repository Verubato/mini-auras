...
L:RegisterLocale("zhCN", function() return {
	...
	["Draws the auras on Blizzard's own party, raid, target and focus frames, in place of the ones the game puts there."] = "在暴雪自带的小队、团队、目标和焦点框架上绘制光环，取代游戏原本放在那里的内容。",
	["Draws the auras on those frames rather than leaving them to Blizzard."] = "在这些框架上绘制光环，而不是交给暴雪处理。",
	["Draws the buffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "在小队和团队框架上绘制增益，并在启用期间关闭暴雪自带的增益。",
	["Draws the debuffs on the party and raid frames, and switches Blizzard's own off while it is on."] = "在小队和团队框架上绘制减益，并在启用期间关闭暴雪自带的减益。",
	["Filtered"] = "已过滤",
	["Glow colour"] = "发光颜色",
	...
	["My buffs"] = "我的增益",
	["My debuffs"] = "我的减益",
	["Nudges the mark sideways from its corner. Positive is right, negative is left."] = "让标记从所在角落左右偏移。正数向右，负数向左。",
	["Nudges the mark up or down from its corner. Positive is up, negative is down."] = "让标记从所在角落上下偏移。正数向上，负数向下。",
	...
	["Refresh window"] = "刷新窗口",
	["Replace the group buffs"] = "替换队伍增益",
	["Replace the group debuffs"] = "替换队伍减益",
	["Replace the target and focus auras"] = "替换目标和焦点光环",
	["Right"] = "右侧",
	["Show the missing buff"] = "显示缺少的增益",
	...
	["Shows only the spells picked in the tracked buffs list below."] = "只显示下方追踪增益列表中选中的法术。",
	["Spell ID"] = "法术 ID",
	["Target & Focus"] = "目标与焦点",
	...
	["Top right"] = "右上",
	["Tracked buffs"] = "追踪的增益",
	["Type a spell id and press Enter. The spell's own id, not the name."] = "输入法术 ID 后按回车。填法术自身的 ID，不是名称。",
	["Under 1min"] = "1 分钟以内",
	["Which corner of the unit frame the mark sits in."] = "标记位于单位框架的哪个角落。",
