...
["Excludes yourself from being tracked."] = "将自己排除在追踪之外。",
	...
	["Shows which group members can interrupt and who is on cooldown."] = "显示队伍中谁能打断、谁在冷却。",
	["Sort by readiness"] = "按就绪排序",
	["Show ready interrupts first, then whoever comes off cooldown soonest."] = "先显示已就绪的打断，再按最快恢复的顺序排列。",
	["Show icon"] = "显示图标",
	["Show the interrupt's spell icon next to each bar."] = "在每个状态条旁显示打断法术的图标。",
	["Bar Width"] = "状态条宽度",
	["Bar Height"] = "状态条高度",
	["Bar Padding"] = "状态条间距",
	["Max Bars"] = "最大状态条数",
	...
	["Show the raid marker of the enemy whose cast was interrupted."] = "显示被打断施法的敌人身上的团队标记。",
	["Bar Texture"] = "状态条材质",
	["Hide when ready"] = "就绪时隐藏",
	["Hide each bar while that member's interrupt is ready, leaving only the ones on cooldown."] = "当某人的打断已就绪时隐藏其状态条，只留下冷却中的。",
})
